...
<a href="<?php echo base_url('admin/add_logo'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
<?php echo form_open('admin/delete_logo','id="form-category"'); ?>  
...
<img src="<?php echo $value->image?base_url($value->image):base_url($config_logo); ?>" width="200" height="100" style="">

</td>

<td class="text-right"><?php echo $value->status==1?'Active':'Deactive'; ?></td>
<td class="text-right">
<a href="<?php echo base_url('admin/add_logo/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
