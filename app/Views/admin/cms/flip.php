...
<a href="<?php echo base_url('admin/add_flip'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
<?php echo form_open('admin/delete_flip','id="form-category"'); ?>  
...
<td class="text-left"><a href="">Heading</a></td>
...
<td class="text-left">
<a href="<?php echo base_url('admin/add_flip/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
