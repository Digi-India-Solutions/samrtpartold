    ...
    <div class="row">
          ...
          <div class="panel-body">
           ...
           <div class="form-group">
            ...
            <div class="form-group text-right">
             <a href="<?php echo base_url('admin/enquiry'); ?>"><button type="button" id="button-filter" class="btn btn-default"><i class="fa fa-reply"></i> Reset</button></a>
      ...
      <?php endif ?>
        ...
        <h3 class="panel-title"><i class="fa fa-list"></i> Customer List</h3>
          ...
          <div class="panel-body">
            <form action="<?php echo base_url('admin/delete_quatation'); ?>" method="post" enctype="multipart/form-data" id="form-customer">
              <table class="table table-bordered table-hover">
               ...
               <tr>   
              <td class="text-left"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
               <td class="text-left"><?php echo $value->name; ?></td>
              <td class="text-left"><?php echo $value->email; ?></td>
             
              <td class="text-left"><?php echo @$value->phone_code.' - '.$value->phone; ?></td>
