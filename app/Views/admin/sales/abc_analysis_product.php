...
<h1>Abc Analysis Product report</h1>
<ul class="breadcrumb">
<li><a href="<?php echo base_url('admin/dashboard'); ?>">Home</a></li>

<li><a href="<?php echo base_url('admin/abc_analysis_product'); ?>">Abc Analysis Product report</a></li>
</ul>
</div>
</div>
...
<h3 class="panel-title"><i class="fa fa-filter"></i> Filter</h3>
 <button type="button" id="export" class="btn btn-success pull-right" style="padding: 5px;margin-top: -6px;" ><i class="fa fa-download"></i> Export Report</button>
</div>
...
<a href="<?php echo base_url('admin/abc_analysis_product'); ?>"><button type="button"  class="btn btn-default">Reset</button></a> &nbsp;
...
<div class="panel panel-default">
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-list"></i>Abc Analysis Product Report</h3>
</div>
<div class="panel-body">
...
<td class="text-left">Total value (price)</td>
</tr>
</thead>
<tbody>
...
<script type="text/javascript">
  ...
  $('#export').on('click',function(){
    ...
    $('form#filter_form').attr('action','admin/export_abc_report');
    $('form#filter_form').submit();
  });

 $('#button-filter').on('click',function(){
    $('form#filter_form').attr('method','GET');
    $('form#filter_form').attr('action','admin/abc_analysis_product',true);
    $('form#filter_form').submit();
  });
