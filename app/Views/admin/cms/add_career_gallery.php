...
<a href="<?php echo base_url('admin/career_gallery'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
...
<?php echo $validation->hasError('sort_order')?$validation->showError('sort_order','my_single'):''; ?>
</div>
</div>
