...
<a href="<?php echo base_url('admin/manage_video'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
...
<label class="col-sm-2 control-label" tititle="only video id is required">Video Url (watch?v=<span style="color:red;">PFeQYOKlhac</span>)</label>
<div class="col-sm-10"> 
<input type="text" class="form-control" name="url_link" value="<?= $url_link; ?>" placeholder="Video Url">
</div>
</div>

<div class="form-group required">
<label class="col-sm-2 control-label">Upload Video (optional)</label>
<div class="col-sm-10"> 
<?php if(@$video){?>
...
<input type="file" class="form-control" name="video" value="<?= $video; ?>" placeholder="Video upload">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="sub_title" value="<?= $sub_title?>" class="form-control" placeholder="Sub Title">
</div>
</div>
<div class="form-group">
...
<div class="col-sm-10"> 
<input type="text" class="form-control" name="btn_link" value="<?= $btn_link; ?>" placeholder="Button Link">
</div>
</div>
