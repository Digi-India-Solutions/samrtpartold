 ...
 <div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <a href="<?php echo base_url('admin/add_currency'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
 ...
 <div class="container-fluid">
  <div class="panel panel-default">
   ...
   <div class="panel-body">
    ...
    <?php echo form_open('admin/delete_currency','id="form-category"'); ?>  
      ...
      <table class="table table-bordered table-hover">
        ...
        <tr>
         <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
           <td class="text-left">Title</td>
            ...
            <td class="text-left">Symbol Left</td>
            <td class="text-left">Symbol Rigth</td>
       ...
       <tbody>
         ...
         <td class="text-left"><?php echo $value->code; ?>  </td>
           <td class="text-left"><?php echo $value->symbol_left; ?>  </td>
             <td class="text-left"><?php echo $value->symbol_right; ?>  </td>
               <td class="text-left"><?php echo $value->value; ?>  </td>

          <td class="text-left"><?php echo $value->status==1?'Active':'Deactive';; ?> </td>
         <td class="text-right">
          <a href="<?php echo base_url('admin/add_currency/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
