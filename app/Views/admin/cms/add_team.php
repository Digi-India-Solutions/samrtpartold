  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo base_url('admin/team'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
          ...
          <fieldset id="option-value">
            ...
            <div class="form-group required ">
              ...
              <div class="col-sm-10">
                ...
                <div class="input-group"><span class="input-group-addon"></span>
                  <input type="text" value="<?php echo set_value('designation',$designation); ?>" name="designation" class="form-control" />
                </div>
