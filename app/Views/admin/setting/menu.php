...
<li><a href="javascript:void();"><?php echo $page_title; ?></a></li>
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
        ...
        <?php 
        $level1 = $this->AdminModel->all_fetch('menu',array('parent_id'=>$value->id,'visible'=>1));
        if ($level1) {
        ...
        <?php 
        $level2 = $this->AdminModel->all_fetch('menu',array('parent_id'=>$l1->id,'visible'=>1));
        if ($level2) {
        ...
        <tr>
         ...
         <?php 
        $level3 = $this->AdminModel->all_fetch('menu',array('parent_id'=>$l2->id,'visible'=>1));
        if ($level3) {
