 ...
 <div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <a href="<?php echo base_url('admin/add_reviews'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
 ...
 <div class="container-fluid">
  <div class="panel panel-default">
   ...
   <div class="panel-body">
    ...
    <?php echo form_open('admin/delete_reviews','id="form-category"'); ?>  
     ...
     <div class="table-responsive">
      ...
      <table class="table table-bordered table-hover">
       <thead>
        <tr>
         <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
           <td class="text-left"><a href="" class="asc">Photo</a></td>
           <td class="text-left"><a href="" class="asc">Name</a></td>
            <td class="text-left"><a href="" class="asc">Designation</a></td>
       ...
       <tbody>
         ...
         <td class="text-left"><img src="<?php echo $value->photo?base_url($value->photo):base_url($config_logo); ?>" width="100" height="100"> </td>
          <td class="text-left"><?php echo $value->name; ?></td>
          <td class="text-left"><?php echo $value->designation; ?></td>
         <td class="text-left"><?php echo $value->sort_order; ?></td>
  
         <td class="text-right"><?php echo $value->status==1?'Active':'Deactive'; ?></td>
         <td class="text-right">
          <a href="<?php echo base_url('admin/add_reviews/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
