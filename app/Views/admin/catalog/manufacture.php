...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo base_url('admin/add_manufacture'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
  ...
  <div class="container-fluid">
    ...
    <?php endif ?>
      ...
      <div class="panel-body">
        <?php echo form_open('admin/delete_manufacture','id="form-manufacturer"'); ?>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
                      <td class="text-left">  
                     <a href="" class="asc">Manufacturer Name</a>
                    </td>
                     <td class="text-right">   
                    <a href="">Sort Order</a>
                    </td>
             ...
             <?php if (!empty($detail)) {foreach ($detail as $key => $value) {?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a href="<?php echo base_url('admin/add_manufacture/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  </td>
                </tr>
