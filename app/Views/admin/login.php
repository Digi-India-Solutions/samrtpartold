...
<link type="text/css" href="<?php echo ADMIN_CATALOG; ?>stylesheet/toastr.css" rel="stylesheet" media="screen" />
...
<div id="content">
  <div class="container-fluid"><br />
    ...
    <img src="<?php echo CATALOG; ?>images/logo.png" alt="logo" style="width: 160px;display: block;margin: 0 auto;" title="LOGO" /></a>
  </div>
...
<script src="<?php echo ADMIN_CATALOG; ?>javascript/jquery/toastr.min.js" type="text/javascript"></script>
<script src="<?php echo ADMIN_CATALOG; ?>javascript/Login.js" type="text/javascript"></script>
<footer id="footer"><a href="">Cyberworx</a> &copy; 2009-<?php echo date('Y');?> All Rights Reserved.<br /></footer></div>
</body></html>
