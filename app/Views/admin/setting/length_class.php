 ...
 <div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <a href="<?php echo base_url('admin/add_length_class'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
 ...
 <div class="container-fluid">
  <div class="panel panel-default">
   ...
   <div class="panel-body">
    ...
    <?php echo form_open('admin/delete_length_class','id="form-category"'); ?>  
     ...
     <div class="table-responsive">
      ...
      <table class="table table-bordered table-hover">
       ...
       <tbody>
         ...
         <td class="text-right">
          <a href="<?php echo base_url('admin/add_length_class/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
