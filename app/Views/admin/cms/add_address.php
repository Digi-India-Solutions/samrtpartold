  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo base_url('admin/address'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
        ...
        <?php echo form_open_multipart($form_action,'id="form-filter" class="form-horizontal"'); ?>  
          ...
          <fieldset id="option-value">
              ...
              <div class="col-sm-10"> 
                ...
                <?php echo $validation->hasError('title')?$validation->showError('title'):''; ?>
               </div>
            </div>
             ...
             <div class="form-group required">
              ...
              <div class="col-sm-10">
                ...
                <div class="input-group">
                  <textarea id="input-description1" data-toggle="summernote" class="form-control"  name="address"><?php echo set_value('address',$address); ?></textarea>
                </div>
           ...
           <!-- <div class="form-group required">
              ...
              <div class="col-sm-10"> 
                ...
                <div class="input-group"><span class="input-group-addon"></span>
                  <textarea rows="5" class="form-control"  name="map"><?php echo set_value('map',$map); ?></textarea>
                </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <?php echo $validation->hasError('status')?$validation->showError('status'):''; ?>
              </div>
            </div>
          </fieldset>
