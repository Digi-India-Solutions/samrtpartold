...
<section class="page-title-section">
    <div class="title-banner">
        <img src="<?php echo base_url($category->image); ?>" alt="title-banner" />
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-title-block text-center">
                        <h2><?php echo $category->banner_heading; ?></h2>
...
<section class="section-space">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 product_lisitng-info">
                     ...
                     <?php if (!empty($filter)) { foreach ($filter['group'] as $key => $value) { if(!empty($filter['option'][$key])){?>
                      ...
                      <?php } } } ?>
                        ...
                        <div class="filter_block active">
                            ...
                            <div class="filter_content">
                                <div id="fee_filter" class="common_selector ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content" data-min="<?php echo $min?$min:'0'; ?>" data-max="<?php echo $max?$max:''; ?>" data-min-set="0" data-max-set="<?php echo $max?$max:''; ?>"></div>
              ...
              <div class="col-xl-4 col-lg-6 col-sm-6">
                  <div class="product-block">
                      <div class="product-image">
                         <a href="<?php echo base_url('categories/'.$category->keyword.'/'.$row['product_seo_url']); ?>"> <img src="<?php echo $row['image']?base_url($row['image']):base_url($config_logo); ?>" alt="<?php echo $row['name']; ?>" /></a>
                      ...
                      <div class="product-info">
                          <a href="<?php echo base_url('categories/'.$category->keyword.'/'.$row['product_seo_url']); ?>"><h2><?php echo $row['name']; ?></h2></a>
                          ...
                          <div class="row align-items-center">
                              ...
                              <div class="col-md-5 pr-0">
                                  <a href="<?php echo base_url('categories/'.$category->keyword.'/'.$row['product_seo_url']); ?>#review">Read Review</a>
                              </div>
                          </div>
                          ...
                          <a href="<?php echo base_url('categories/'.$category->keyword.'/'.$row['product_seo_url']); ?>" class="theme-btn full">SHOP NOW</a>
                      </div>
                  </div>
              </div>
...
$('form#filter_form').submit(function(e){
     var type = $('#type').val();
      ...
      var form = $(this);
      $.ajax({
      url:"<?php echo base_url('get_product_ajax'); ?>",
      type:"POST",
      data:form.serialize(),
      beforeSend:function(){
          if(type=='load'){
