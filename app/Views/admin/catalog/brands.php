...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo base_url('admin/add_brands'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
  ...
  <div class="container-fluid">
    ...
    <?php endif ?>
      ...
      <div class="panel-body">
        <?php echo form_open('admin/delete_brands','id="form-manufacturer"'); ?>
            ...
            <table class="table table-bordered table-hover">
             ...
             <?php if (!empty($list)) {foreach ($list as $key => $value) {?>
                ...
                <tr>
                  ...
                  <td class="text-left"><img src="<?php echo $value->image?base_url($value->image):base_url($config_logo); ?>" alt="" width="50" height="50"></td>
                  <td class="text-right"><?php echo $value->sort_order; ?></td>
                   <td class="text-right"><?php echo $value->status?'Active':'Deactive';; ?></td>
                  <td class="text-right">
                    <a href="<?php echo base_url('admin/add_brands/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  </td>
                </tr>
