 ...
 <div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <a href="<?php echo base_url('admin/add_career_gallery'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
<?php endif ?>
   ...
   <div class="panel-body">
    ...
    <?php echo form_open('admin/delete_career_gallery','id="form-category"'); ?>  
     ...
     <div class="table-responsive">
      ...
      <table class="table table-bordered table-hover">
       ...
       <tbody>
         ...
         <td class="text-right">
          <a href="<?php echo base_url('admin/add_career_gallery/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
