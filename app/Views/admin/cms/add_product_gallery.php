...
<a href="<?php echo base_url('admin/product_gallery'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
...
<!--<div class="col-sm-10">-->
<!--<input type="text" name="title" value="<?php echo set_value('title',$title); ?>" class="form-control" placeholder="title">-->
...
<div class="col-sm-10">
<input type="number" name="sort_order" value="<?php echo set_value('sort_order',$sort_order); ?>" class="form-control" placeholder="sort order">
</div>
</div>
