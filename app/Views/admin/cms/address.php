...
<?php echo form_open('admin/delete_address','id="form-category"'); ?>  
...
<td class="text-left"><a href="" class="asc">Address</a></td>
...
<td class="text-right"><?php echo $value->status==1?'Enabled':'Disabled'; ?></td>
<td class="text-right">
