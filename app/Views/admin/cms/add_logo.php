...
<a href="<?php echo base_url('admin/manage_logo'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
...
<label class="col-sm-2 control-label">Upload Client Logo </label>
<div class="col-sm-10"> 
...
<?php echo $validation->hasError('link')?$validation->showError('link','my_single'):''; ?>
</div>
</div>
