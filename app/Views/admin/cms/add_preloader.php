  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo base_url('admin/preloader'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
        ...
        <?php echo form_open_multipart($form_action,'id="form-filter" class="form-horizontal"'); ?>  
          ...
          <fieldset id="option-value">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label">Upload Loader (GIF,MP4 VIDEO,IMAGE)</label>
              <div class="col-sm-10"> 
