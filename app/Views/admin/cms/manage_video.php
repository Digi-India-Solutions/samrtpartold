...
<a href="<?php echo base_url('admin/add_manage_video'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
<?php echo form_open('admin/delete_manage_video','id="form-category"'); ?>  
...
<td class="text-right"><a href="">Sub Title</a></td>
...
<td class="text-left"><?php echo $value->sub_title; ?></td>
<td class="text-right"><?php echo $value->status==1?'Active':'Deactive'; ?></td>
<td class="text-right">
<a href="<?php echo base_url('admin/add_manage_video/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
