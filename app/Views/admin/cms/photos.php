 ...
 <div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <a href="<?php echo base_url('admin/add_photos'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
<?php endif ?>
   ...
   <div class="panel-body">
    ...
    <?php echo form_open('admin/delete_photo','id="form-category"'); ?>  
     ...
     <div class="table-responsive">
      ...
      <table class="table table-bordered table-hover">
       ...
       <tbody>
         ...
         <td class="text-left"><img src="<?php echo $value->photo?base_url($value->photo):base_url('uploads/images/1630487224_7b3fc6e15e6951de3ef6.png'); ?>" width="100" height="100"> </td>
         <td class="text-left"><?php echo $type_list[$value->type]; ?></td>
         <td class="text-left"><?php echo $value->sort_order; ?></td>
  
         <td class="text-right"><?php echo $value->status==1?'Active':'Deactive'; ?></td>
         <td class="text-right">
          <a href="<?php echo base_url('admin/add_photos/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
