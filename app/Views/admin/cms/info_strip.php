...
<a href="<?php echo base_url('admin/add_info_strip'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
<?php endif ?>
<h3 class="panel-title"><i class="fa fa-list"></i> Logo List</h3>
</div>
<div class="panel-body">
<?php echo form_open('admin/delete_info_strip','id="form-category"'); ?>  
...
<td class="text-left"><a href="" class="asc">Info Strip</a></td>
...
<tbody>
<?php foreach ($strip as $key => $value){
...
<td class="text-right">
<a href="<?php echo base_url('admin/add_info_strip/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
