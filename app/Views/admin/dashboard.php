...
<div class="tile-footer"><a href="<?php echo base_url('admin/order'); ?>">View more...</a></div>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6">
<div class="tile tile-primary">
...
<div class="tile-footer"><a href="<?php echo base_url('admin/subscribe'); ?>">View more...</a></div>
</div>
</div>
...
({
type: "POST",
url: '<?= base_url(); ?>admin/Backend/get_map',
dataType : 'json',
data: dataString,
cache: false,
...
<div class="panel panel-default">
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-shopping-cart"></i> Latest Product Enquiry</h3>
</div>
<div class="table-responsive">
<table class="table">
<thead>
...
<tbody>
<?php if (!empty($latest_order)) {foreach ($latest_order as $key => $value) {?>
<tr>
...
<td class="text-right"><a href="<?php echo base_url('admin/product_enquiry'); ?>"><button class="btn btn-primary">View</button></a></td>
</tr>
<?php } } ?>
</tbody>
</table>
