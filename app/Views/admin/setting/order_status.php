 ...
 <div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <a href="<?php echo base_url('admin/add_order_status'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
 ...
 <div class="container-fluid">
  <div class="panel panel-default">
   ...
   <div class="panel-body">
    ...
    <?php echo form_open('admin/delete_order_status','id="form-category"'); ?>  
     ...
     <div class="table-responsive">
      ...
      <table class="table table-bordered table-hover">
       ...
       <tbody>
         ...
         <td class="text-right">
          <a href="<?php echo base_url('admin/add_order_status/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
