 ...
 <div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <a href="<?php echo base_url('admin/add_state'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
 ...
 <div class="container-fluid">
  <div class="panel panel-default">
   ...
   <div class="panel-body">
    ...
    <?php echo form_open('admin/delete_state','id="form-category"'); ?>  
      ...
      <table class="table table-bordered table-hover">
       ...
       <tbody>
         ...
         <td class="text-center"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
          ...
          <td class="text-left"><?php echo $country_list[$value->country_id]; ?>  </td>
          <td class="text-left"><?php echo $value->status==1?'Active':'Deactive'; ?>  </td>
          <td class="text-right">
          <a href="<?php echo base_url('admin/add_state/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
