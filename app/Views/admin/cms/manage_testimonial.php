...
<?php endif ?>
<h3 class="panel-title"><i class="fa fa-list"></i> Testimonial List</h3>
</div>
<div class="panel-body">
<?php echo form_open('admin/delete_testimonial','id="form-category"'); ?>  
...
<td class="text-right"><a href="">Designation</a></td>
...
<td class="text-left">
<img src="<?php echo $value->image?base_url($value->image):''; ?>" width="150" height="150">
</td>
