...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo base_url('admin/add_twowheeler_brands'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
  ...
  <div class="container-fluid">
    ...
    <?php endif ?>
      ...
      <div class="panel-body">
        <?php echo form_open('admin/delete_twowheeler_brands','id="form-manufacturer"'); ?>
            ...
            <table class="table table-bordered table-hover">
             ...
             <?php if (!empty($detail)) {foreach ($detail as $key => $value) {?>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a href="<?php echo base_url('admin/add_twowheeler_brands/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  </td>
                </tr>
