  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo base_url('admin/brand_category'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-name">Brand Category Name</label>
                <div class="col-sm-10">
            ...
            <!--   <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sort-order">Show on Home </label>
                 <div class="col-sm-10">
                  <input type="checkbox" name="show_home" <?php echo $show_home?'checked':'';; ?> value="1" />
                </div>
              </div> -->
