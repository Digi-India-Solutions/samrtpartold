...
<h1>Average inventory sold per day report</h1>
<ul class="breadcrumb">
<li><a href="<?php echo base_url('admin/dashboard'); ?>">Home</a></li>
<li><a href="<?php echo base_url('admin/average_inventory_reports'); ?>">Average inventory sold per day report</a></li>
</ul>
</div>
</div>
...
<a href="<?php echo base_url('admin/average_inventory_reports'); ?>"><button type="button"  class="btn btn-default">Reset</button></a> &nbsp;
...
<div class="panel panel-default">
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-list"></i>Average inventory sold per day report</h3>
</div>
<div class="panel-body">
...
<td class="text-left">Quantity sold per day</td>
</tr>
</thead>
<tbody>
...
<script type="text/javascript">
  ...
  $('#export').on('click',function(){
    ...
    $('form#filter_form').attr('action','admin/export_inventory_average_report');
    $('form#filter_form').submit();
  });

 $('#button-filter').on('click',function(){
    $('form#filter_form').attr('method','GET');
    $('form#filter_form').attr('action','admin/average_inventory_reports',true);
    $('form#filter_form').submit();
  });
