...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo base_url('admin/add_bgfree'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
      ...
      <ul class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('admin/bgfree'); ?>"><?php echo $page_title; ?></a></li>
        </ul>
    </div>
  </div>
  <div class="container-fluid">
            ...
            <table class="table table-bordered table-hover">
             ...
             <?php if (!empty($detail)) {foreach ($detail as $key => $value) {
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $value->date_start; ?></td>
                  <td class="text-left"><?php echo $value->date_end; ?></td>
                  <td class="text-left"><?php echo $value->status=='1'?'Enabled':'Disabled'; ?></td>
                  <td class="text-right"><?php echo $value->sort_order; ?></td>
                  <td class="text-right">
                    <a href="<?php echo base_url('admin/add_bgfree/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  </td>
                </tr>
